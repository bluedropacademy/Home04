      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center w-full">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-4">
            הפכנו את החומר היבש מהכיתה לסדרת סרטונים מטורפת בסגנון שאתם אוהבים!
            <br className="hidden sm:block" />
            נתקעתם עם שאלה? יש לכם צ'אט גאון, מורה פרטי שיודע לענות על כל שאלה שיש לכם. תשאלו אותו מה שבא לכם, מתי שבא לכם!
          </p>
