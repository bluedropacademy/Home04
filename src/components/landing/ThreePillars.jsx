...
const pillars = [
  {
    icon: Video,
    title: "ספריית הסרטונים – הגיע הזמן ללמוד כמו ביוטיוב!",
    color: "from-orange-400 to-orange-500",
    description: "כיוטיובר עם עשרות מיליוני צפיות, אני לוקח את הניסיון שלי ומסביר לכם כל נושא לימודי בסגנון כיפי וברור, בשפה שלכם – בגובה העיניים, עם קצב מהיר והומור.",
    features: [],
  ...
  {
    icon: BookOpen,
    title: "בלופדיה – כל המקצועות במקום אחד!",
    color: "from-purple-500 to-purple-600",
    description: "לא יודעים מאיפה להתחיל את הלימוד? בלופדיה היא נקודת הפתיחה שלכם לכל מקצוע. כאן תמצאו את כל המקצועות מחולקים לנושאים מסודרים שעליהם תוכלו לדבר עם בלו – מהיסטוריה ועד אזרחות ומדעים. זו הדרך החכמה, הפשוטה והכיפית שלכם להבין ולשלוט בחומר.",
    features: [],
    buttonText: "לבלופדיה",
  ...
  {
    icon: Bot,
    title: "בלו – מורה אישי פרטי שמלמד בכיף.",
    color: "from-blue-500 to-blue-600",
    description: "בלו הוא צ'אט חכם מבוסס בינה מלאכותית שהותאם במיוחד לתלמיד הישראלי. הוא שולט בכל נושאי הלימוד, מדבר עברית שוטפת עם סלנג ישראלי ובגובה העיניים, יוצר מבחנים ומסביר כמו חבר שמבין אותך באמת, בדרך פשוטה, כיפית וברורה",
    features: [],
